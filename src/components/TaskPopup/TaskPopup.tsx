        ...
        {task ? (
          <>
            ...
            <input
              ...
              onBlur={onBlurTitle}
            />
            {task.isDone && <div className="done-text">Task is done</div>}
            <div
              className={
                dates.isSameOrAfter(Date.now(), task.dueDate) ? 'due-date red' : 'due-date'
              }>
              Due date – {dates.format(task.dueDate, 'DD.MM.YYYY')}
            </div>
